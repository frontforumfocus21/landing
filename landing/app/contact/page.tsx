...
export default function Page() {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] py-20" aria-label="Contact Us">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl mx-auto">
              Have questions about sustainability reporting? Reach out directly or use our contact form below.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="rounded-2xl border border-blue-100 dark:border-blue-900/50 bg-blue-50/30 dark:bg-blue-900/20 p-8 backdrop-blur-lg"
            >
              <ContactForm />
            </motion.div>
            ...
            <motion.div
              ...
              className="rounded-2xl border border-blue-100 dark:border-blue-900/50 bg-blue-50/30 dark:bg-blue-900/20 p-8 backdrop-blur-lg space-y-4"
            >
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">frontforumfocus@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">+254 (724) 799-167</p>
                  </div>
                </div>
              </div>
            </motion.div>
